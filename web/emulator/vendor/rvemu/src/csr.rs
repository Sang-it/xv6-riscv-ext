...
const STIMECMP: CsrAddress = 0x14d;
const MENVCFG: CsrAddress = 0x30a;
...
impl State {
    ...
    pub fn new() -> Self {
        ...
        csrs[STIMECMP as usize] = u64::MAX;
    ...
    pub fn increment_time(&mut self) {
        ...
        // xv6 uses Sstc instead of the older machine-mode timer trampoline.
        if self.csrs[MENVCFG as usize] & (1 << 63) != 0 {
            if self.csrs[TIME as usize] >= self.csrs[STIMECMP as usize] {
                self.csrs[MIP as usize] |= STIP_BIT;
            } else {
                self.csrs[MIP as usize] &= !STIP_BIT;
            }
        }
    ...
    pub fn reset(&mut self) {
        ...
        self.csrs[STIMECMP as usize] = u64::MAX;
    }
}
